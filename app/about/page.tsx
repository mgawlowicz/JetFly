        ...
        <main className="flex flex-col gap-20 lg:gap-36">
            ...
            <div className="w-full px-4 lg:px-16 flex flex-col lg:flex-row gap-8">
                <div className="w-full lg:w-1/3 flex flex-col gap-2">
                    <h4 className="text-xl lg:text-3xl font-bold">Comfort</h4>
                ...
                <div className="w-full lg:w-1/3 flex flex-col gap-2">
                    <h4 className="text-xl lg:text-3xl font-bold">Insurance</h4>
                ...
                <div className="w-full lg:w-1/3 flex flex-col gap-2">
                    <h4 className="text-xl lg:text-3xl font-bold">Services 24/7</h4>
