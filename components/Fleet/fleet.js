    ...
    return(
        <div className="flex flex-col gap-12">
            ...
            <div className="flex flex-col">
                <Link href={'/fleet/gulfstream-g550'} className="relative w-full h-72 lg:h-96 font-bold hover:h-128 transition-all duration-500">
                ...
                <Link href={'/fleet/gulfstream-g600'} className="relative w-full h-72 lg:h-96 font-bold hover:h-128 transition-all duration-500">
                ...
                <Link href={'/fleet/dassault-falcon-7x'} className="relative w-full h-72 lg:h-96 font-bold hover:h-128 transition-all duration-500">
