        ...
        <div className="flex flex-col gap-4 relative">
            ...
            <motion.div className="absolute h-screen flex flex-col justify-center p-4 lg:p-16 lg:w-1/2 gap-10 lg:gap-20" variants={container} initial="hidden" animate="show">
                ...
                <motion.div variants={item}>
                    <Link href="/charter" className="flex w-max px-16 py-2 border-2 border-white border-solid font-semibold hover:bg-white hover:text-black transition duration-300 ease-in-out">Charter jet</Link>
                </motion.div>
            </motion.div>
